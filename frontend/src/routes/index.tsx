...
function Login() {
  ...
  const [mode, setMode] = useState<"login" | "forgot_email" | "forgot_otp" | "forgot_reset">(
    "login",
  );
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          {mode === "forgot_otp" && (
            <>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                We sent a verification code to check it's really you.
              </p>
              ...
              <form onSubmit={handleForgotOtpSubmit} className="mt-6 space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full h-11 bg-gradient-to-r from-[#1F3A6E] to-[#6C63FF] text-white"
                >
                  Continue
                </Button>
              </form>
