  ...
  const stages = [
    {
      ...
      time: profile.applied_at
        ? new Date(profile.applied_at).toLocaleString(undefined, {
            dateStyle: "medium",
            timeStyle: "short",
          })
        : "—",
    ...
    },
    {
      label: "Under Review",
      time:
        isUnderReview || isApproved || isRejected ? "Evaluation Initiated" : "Awaiting Evaluation",
      state:
    ...
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Track every stage of your candidacy in real time.
        </p>
      </div>
