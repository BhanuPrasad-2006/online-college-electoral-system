    ...
    setSteps([
      {
        ...
        description:
          'Your candidacy application has been received',
        status: 'completed',
      ...
      },
      {
        ...
        description:
          'Admin is reviewing your eligibility',
        status: 'current',
      },
      {
      ...
      {
        label: 'Manifesto Submitted',
        description:
          'Your election manifesto has been submitted',
        status: 'upcoming',
      },
      {
        label: 'Final Approval',
        description:
          'Admin approves your candidacy',
        status: 'upcoming',
      },
    ]);
  }, []);
    ...
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-surface-400">
          Track your candidacy application progress
        </p>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xl font-semibold text-surface-100 mt-1">
              {cfg[applicationStatus].label}
            </p>
          </div>

          <Badge
            variant={cfg[applicationStatus].variant}
          >
            {cfg[applicationStatus].label}
          </Badge>
        </div>
